class CfgMagazines {
    ...
    class PBW_DM51A1_Frag: HandGrenade {
        ...
        scope = 2;
        displayName = "$STR_pbw_handgrenades_DM51A1_Frag_Name";
        displayNameShort = "$STR_pbw_handgrenades_DM51A1_Frag_NameShort";
        descriptionShort = "$STR_pbw_handgrenades_DM51A1_Frag_Desc";
    ...
    class PBW_DM51A1_NoFrag: PBW_DM51A1_Frag {
        displayName = "$STR_pbw_handgrenades_DM51A1_NoFrag_Name";
        displayNameShort = "$STR_pbw_handgrenades_DM51A1_NoFrag_NameShort";
        descriptionShort = "$STR_pbw_handgrenades_DM51A1_NoFrag_Desc";
